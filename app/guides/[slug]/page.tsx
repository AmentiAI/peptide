        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="prose prose-lg prose-gray max-w-none
              ...
              prose-h2:text-2xl prose-h2:mt-14 prose-h2:mb-5 prose-h2:pb-3 prose-h2:border-b-2 prose-h2:border-gray-100
              prose-h3:text-xl prose-h3:mt-10 prose-h3:mb-3 prose-h3:text-indigo-900
              prose-h4:text-lg prose-h4:mt-8 prose-h4:mb-2 prose-h4:text-gray-800
              prose-p:text-gray-600 prose-p:leading-[1.85] prose-p:my-5 prose-p:text-[1.05rem]
              ...
              prose-li:text-[1.02rem] prose-li:leading-relaxed prose-li:pl-1
              prose-hr:my-10 prose-hr:border-gray-200
              prose-table:text-sm prose-table:w-full
              prose-thead:bg-indigo-50
              prose-th:text-indigo-900 prose-th:font-bold prose-th:py-3 prose-th:px-4 prose-th:text-left
              prose-td:py-3 prose-td:px-4 prose-td:text-gray-600 prose-td:border-b prose-td:border-gray-100
              prose-blockquote:border-l-4 prose-blockquote:border-indigo-400 prose-blockquote:bg-indigo-50 prose-blockquote:rounded-r-xl prose-blockquote:py-4 prose-blockquote:px-6 prose-blockquote:not-italic prose-blockquote:my-8
              prose-blockquote:text-indigo-900 prose-blockquote:font-medium
              prose-code:bg-gray-100 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-indigo-700 prose-code:text-[0.9em] prose-code:before:content-none prose-code:after:content-none
              prose-pre:bg-gray-900 prose-pre:rounded-xl prose-pre:my-8
            ">
